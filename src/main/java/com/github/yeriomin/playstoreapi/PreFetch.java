...
public  final class PreFetch extends
  ...
  public com.github.yeriomin.playstoreapi.ResponseWrapper getResponse() {
    return response_ == null ? com.github.yeriomin.playstoreapi.ResponseWrapper.getDefaultInstance() : response_;
  }
  /**
   * <code>optional .ResponseWrapper response = 2;</code>
   */
  private void setResponse(com.github.yeriomin.playstoreapi.ResponseWrapper value) {
    if (value == null) {
      throw new NullPointerException();
    }
    response_ = value;
   ...
   * <code>optional .ResponseWrapper response = 2;</code>
   */
  private void mergeResponse(com.github.yeriomin.playstoreapi.ResponseWrapper value) {
    if (response_ != null &&
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.github.yeriomin.playstoreapi.PreFetch, Builder> implements
      // @@protoc_insertion_point(builder_implements:PreFetch)
      com.github.yeriomin.playstoreapi.PreFetchOrBuilder {
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.github.yeriomin.playstoreapi.PreFetch();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        com.github.yeriomin.playstoreapi.PreFetch other = (com.github.yeriomin.playstoreapi.PreFetch) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.github.yeriomin.playstoreapi.PreFetch.class) {
            if (PARSER == null) {
  ...
  private static final com.github.yeriomin.playstoreapi.PreFetch DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new PreFetch();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static com.github.yeriomin.playstoreapi.PreFetch getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
