...
public interface AndroidCheckinProtoOrBuilder extends
   ...
   * <code>optional .AndroidBuildProto build = 1;</code>
   */
  com.github.yeriomin.playstore.api.AndroidBuildProto getBuild();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.api.AndroidEventProto> 
      getEventList();
  /**
   * <code>repeated .AndroidEventProto event = 3;</code>
   */
  com.github.yeriomin.playstore.api.AndroidEventProto getEvent(int index);
  /**
   * <code>repeated .AndroidEventProto event = 3;</code>
   */
  int getEventCount();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.api.AndroidStatisticProto> 
      getStatList();
  /**
   * <code>repeated .AndroidStatisticProto stat = 4;</code>
   */
  com.github.yeriomin.playstore.api.AndroidStatisticProto getStat(int index);
  /**
   * <code>repeated .AndroidStatisticProto stat = 4;</code>
   */
  int getStatCount();
