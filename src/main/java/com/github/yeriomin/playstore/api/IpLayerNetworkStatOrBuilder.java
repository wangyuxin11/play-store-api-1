...
public interface IpLayerNetworkStatOrBuilder extends
   ...
   */
  java.util.List<com.github.yeriomin.playstore.api.IpLayerNetworkBucket> 
      getIpLayerNetworkBucketList();
  /**
   * <code>repeated .IpLayerNetworkBucket ipLayerNetworkBucket = 3;</code>
   */
  com.github.yeriomin.playstore.api.IpLayerNetworkBucket getIpLayerNetworkBucket(int index);
  /**
   * <code>repeated .IpLayerNetworkBucket ipLayerNetworkBucket = 3;</code>
   */
   ...
   */
  java.util.List<com.github.yeriomin.playstore.api.IpLayerAppStat> 
      getIpLayerAppStatList();
  /**
   * <code>repeated .IpLayerAppStat ipLayerAppStat = 4;</code>
   */
  com.github.yeriomin.playstore.api.IpLayerAppStat getIpLayerAppStat(int index);
  /**
   * <code>repeated .IpLayerAppStat ipLayerAppStat = 4;</code>
   */
