...
public interface BookDetailsOrBuilder extends
   ...
   */
  java.util.List<com.github.yeriomin.playstore.api.BookSubject> 
      getSubjectList();
  /**
   * <code>repeated .BookSubject subject = 3;</code>
   */
  com.github.yeriomin.playstore.api.BookSubject getSubject(int index);
  /**
   * <code>repeated .BookSubject subject = 3;</code>
   */
  int getSubjectCount();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.api.BookAuthor> 
      getAuthorList();
  /**
   * <code>repeated .BookAuthor author = 9;</code>
   */
  com.github.yeriomin.playstore.api.BookAuthor getAuthor(int index);
  /**
   * <code>repeated .BookAuthor author = 9;</code>
   */
  int getAuthorCount();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.api.BookDetails.Identifier> 
      getIdentifierList();
  /**
   * <code>repeated group Identifier = 18 { ... }</code>
   */
  com.github.yeriomin.playstore.api.BookDetails.Identifier getIdentifier(int index);
  /**
   * <code>repeated group Identifier = 18 { ... }</code>
   */
