...
public interface AndroidCheckinProtoOrBuilder extends
   ...
   * <code>optional .AndroidBuildProto build = 1;</code>
   */
  com.github.yeriomin.playstore.message.AndroidBuildProto getBuild();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.AndroidEventProto> 
      getEventList();
  /**
   * <code>repeated .AndroidEventProto event = 3;</code>
   */
  com.github.yeriomin.playstore.message.AndroidEventProto getEvent(int index);
  /**
   * <code>repeated .AndroidEventProto event = 3;</code>
   */
  int getEventCount();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.AndroidStatisticProto> 
      getStatList();
  /**
   * <code>repeated .AndroidStatisticProto stat = 4;</code>
   */
  com.github.yeriomin.playstore.message.AndroidStatisticProto getStat(int index);
  /**
   * <code>repeated .AndroidStatisticProto stat = 4;</code>
   */
  int getStatCount();
