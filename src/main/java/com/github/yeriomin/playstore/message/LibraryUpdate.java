...
public  final class LibraryUpdate extends
  ...
  private com.google.protobuf.Internal.ProtobufList<com.github.yeriomin.playstore.message.LibraryMutation> mutation_;
  /**
   * <code>repeated .LibraryMutation mutation = 4;</code>
   */
  public java.util.List<com.github.yeriomin.playstore.message.LibraryMutation> getMutationList() {
    return mutation_;
  }
  /**
   * <code>repeated .LibraryMutation mutation = 4;</code>
   */
  public java.util.List<? extends com.github.yeriomin.playstore.message.LibraryMutationOrBuilder> 
   ...
   * <code>repeated .LibraryMutation mutation = 4;</code>
   */
  public com.github.yeriomin.playstore.message.LibraryMutation getMutation(int index) {
    return mutation_.get(index);
  }
  /**
   * <code>repeated .LibraryMutation mutation = 4;</code>
   */
  public com.github.yeriomin.playstore.message.LibraryMutationOrBuilder getMutationOrBuilder(
      int index) {
    return mutation_.get(index);
  }
  ...
  private void setMutation(
      int index, com.github.yeriomin.playstore.message.LibraryMutation value) {
    if (value == null) {
      throw new NullPointerException();
    }
   ...
   */
  private void setMutation(
      int index, com.github.yeriomin.playstore.message.LibraryMutation.Builder builderForValue) {
    ensureMutationIsMutable();
   ...
   * <code>repeated .LibraryMutation mutation = 4;</code>
   */
  private void addMutation(com.github.yeriomin.playstore.message.LibraryMutation value) {
    if (value == null) {
      throw new NullPointerException();
    }
    ensureMutationIsMutable();
   ...
   */
  private void addMutation(
      com.github.yeriomin.playstore.message.LibraryMutation.Builder builderForValue) {
    ensureMutationIsMutable();
  ...
  private void addAllMutation(
      java.lang.Iterable<? extends com.github.yeriomin.playstore.message.LibraryMutation> values) {
    ensureMutationIsMutable();
  ...
  public static com.github.yeriomin.playstore.message.LibraryUpdate parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.LibraryUpdate parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static com.github.yeriomin.playstore.message.LibraryUpdate parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.LibraryUpdate parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static com.github.yeriomin.playstore.message.LibraryUpdate parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.github.yeriomin.playstore.message.LibraryUpdate prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.github.yeriomin.playstore.message.LibraryUpdate, Builder> implements
      // @@protoc_insertion_point(builder_implements:LibraryUpdate)
      com.github.yeriomin.playstore.message.LibraryUpdateOrBuilder {
     ...
     * <code>repeated .LibraryMutation mutation = 4;</code>
     */
    public Builder addMutation(com.github.yeriomin.playstore.message.LibraryMutation value) {
      copyOnWrite();
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.github.yeriomin.playstore.message.LibraryUpdate();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        com.github.yeriomin.playstore.message.LibraryUpdate other = (com.github.yeriomin.playstore.message.LibraryUpdate) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                ...
                mutation_.add(
                    input.readMessage(com.github.yeriomin.playstore.message.LibraryMutation.parser(), extensionRegistry));
                break;
              }
              case 40: {
                bitField0_ |= 0x00000008;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.github.yeriomin.playstore.message.LibraryUpdate.class) {
            if (PARSER == null) {
  ...
  private static final com.github.yeriomin.playstore.message.LibraryUpdate DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new LibraryUpdate();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static com.github.yeriomin.playstore.message.LibraryUpdate getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
