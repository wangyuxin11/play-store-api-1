...
public  final class AndroidCheckinResponse extends
  ...
  private com.google.protobuf.Internal.ProtobufList<com.github.yeriomin.playstore.message.AndroidIntentProto> intent_;
  /**
   * <code>repeated .AndroidIntentProto intent = 2;</code>
   */
  public java.util.List<com.github.yeriomin.playstore.message.AndroidIntentProto> getIntentList() {
    return intent_;
  }
  /**
   * <code>repeated .AndroidIntentProto intent = 2;</code>
   */
  public java.util.List<? extends com.github.yeriomin.playstore.message.AndroidIntentProtoOrBuilder> 
   ...
   * <code>repeated .AndroidIntentProto intent = 2;</code>
   */
  public com.github.yeriomin.playstore.message.AndroidIntentProto getIntent(int index) {
    return intent_.get(index);
  }
  /**
   * <code>repeated .AndroidIntentProto intent = 2;</code>
   */
  public com.github.yeriomin.playstore.message.AndroidIntentProtoOrBuilder getIntentOrBuilder(
      int index) {
    return intent_.get(index);
  }
  ...
  private void setIntent(
      int index, com.github.yeriomin.playstore.message.AndroidIntentProto value) {
    if (value == null) {
   ...
   */
  private void setIntent(
      int index, com.github.yeriomin.playstore.message.AndroidIntentProto.Builder builderForValue) {
    ensureIntentIsMutable();
   ...
   * <code>repeated .AndroidIntentProto intent = 2;</code>
   */
  private void addIntent(com.github.yeriomin.playstore.message.AndroidIntentProto value) {
    if (value == null) {
      throw new NullPointerException();
    }
    ensureIntentIsMutable();
   ...
   */
  private void addIntent(
      com.github.yeriomin.playstore.message.AndroidIntentProto.Builder builderForValue) {
    ensureIntentIsMutable();
  ...
  private void addAllIntent(
      java.lang.Iterable<? extends com.github.yeriomin.playstore.message.AndroidIntentProto> values) {
    ensureIntentIsMutable();
  ...
  private com.google.protobuf.Internal.ProtobufList<com.github.yeriomin.playstore.message.GservicesSetting> setting_;
  /**
   * <code>repeated .GservicesSetting setting = 5;</code>
   */
  public java.util.List<com.github.yeriomin.playstore.message.GservicesSetting> getSettingList() {
    return setting_;
  }
  /**
   * <code>repeated .GservicesSetting setting = 5;</code>
   */
  public java.util.List<? extends com.github.yeriomin.playstore.message.GservicesSettingOrBuilder> 
   ...
   * <code>repeated .GservicesSetting setting = 5;</code>
   */
  public com.github.yeriomin.playstore.message.GservicesSetting getSetting(int index) {
    return setting_.get(index);
  }
  /**
   * <code>repeated .GservicesSetting setting = 5;</code>
   */
  public com.github.yeriomin.playstore.message.GservicesSettingOrBuilder getSettingOrBuilder(
      int index) {
    return setting_.get(index);
  }
  ...
  private void setSetting(
      int index, com.github.yeriomin.playstore.message.GservicesSetting value) {
    if (value == null) {
      throw new NullPointerException();
    }
   ...
   */
  private void setSetting(
      int index, com.github.yeriomin.playstore.message.GservicesSetting.Builder builderForValue) {
    ensureSettingIsMutable();
   ...
   * <code>repeated .GservicesSetting setting = 5;</code>
   */
  private void addSetting(com.github.yeriomin.playstore.message.GservicesSetting value) {
    if (value == null) {
      throw new NullPointerException();
    }
    ensureSettingIsMutable();
   ...
   */
  private void addSetting(
      com.github.yeriomin.playstore.message.GservicesSetting.Builder builderForValue) {
    ensureSettingIsMutable();
  ...
  private void addAllSetting(
      java.lang.Iterable<? extends com.github.yeriomin.playstore.message.GservicesSetting> values) {
    ensureSettingIsMutable();
    com.google.protobuf.AbstractMessageLite.addAll(
        values, setting_);
  }
  ...
  public static com.github.yeriomin.playstore.message.AndroidCheckinResponse parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.AndroidCheckinResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static com.github.yeriomin.playstore.message.AndroidCheckinResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.AndroidCheckinResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static com.github.yeriomin.playstore.message.AndroidCheckinResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.github.yeriomin.playstore.message.AndroidCheckinResponse prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.github.yeriomin.playstore.message.AndroidCheckinResponse, Builder> implements
      // @@protoc_insertion_point(builder_implements:AndroidCheckinResponse)
      com.github.yeriomin.playstore.message.AndroidCheckinResponseOrBuilder {
     ...
     * <code>repeated .AndroidIntentProto intent = 2;</code>
     */
    public Builder addIntent(com.github.yeriomin.playstore.message.AndroidIntentProto value) {
      copyOnWrite();
     ...
     * <code>repeated .GservicesSetting setting = 5;</code>
     */
    public Builder addSetting(com.github.yeriomin.playstore.message.GservicesSetting value) {
      copyOnWrite();
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.github.yeriomin.playstore.message.AndroidCheckinResponse();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        com.github.yeriomin.playstore.message.AndroidCheckinResponse other = (com.github.yeriomin.playstore.message.AndroidCheckinResponse) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                ...
                intent_.add(
                    input.readMessage(com.github.yeriomin.playstore.message.AndroidIntentProto.parser(), extensionRegistry));
                break;
              }
              case 24: {
                bitField0_ |= 0x00000002;
              ...
              case 42: {
                ...
                setting_.add(
                    input.readMessage(com.github.yeriomin.playstore.message.GservicesSetting.parser(), extensionRegistry));
                break;
              }
              case 48: {
                bitField0_ |= 0x00000008;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.github.yeriomin.playstore.message.AndroidCheckinResponse.class) {
            if (PARSER == null) {
  ...
  private static final com.github.yeriomin.playstore.message.AndroidCheckinResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AndroidCheckinResponse();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static com.github.yeriomin.playstore.message.AndroidCheckinResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
