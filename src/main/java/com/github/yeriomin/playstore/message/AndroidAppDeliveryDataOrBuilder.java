...
public interface AndroidAppDeliveryDataOrBuilder extends
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.AppFileMetadata> 
      getAdditionalFileList();
  /**
   * <code>repeated .AppFileMetadata additionalFile = 4;</code>
   */
  com.github.yeriomin.playstore.message.AppFileMetadata getAdditionalFile(int index);
  /**
   * <code>repeated .AppFileMetadata additionalFile = 4;</code>
   */
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.HttpCookie> 
      getDownloadAuthCookieList();
  /**
   * <code>repeated .HttpCookie downloadAuthCookie = 5;</code>
   */
  com.github.yeriomin.playstore.message.HttpCookie getDownloadAuthCookie(int index);
  /**
   * <code>repeated .HttpCookie downloadAuthCookie = 5;</code>
   */
   ...
   * <code>optional .AndroidAppPatchData patchData = 11;</code>
   */
  com.github.yeriomin.playstore.message.AndroidAppPatchData getPatchData();
   ...
   * <code>optional .EncryptionParams encryptionParams = 12;</code>
   */
  com.github.yeriomin.playstore.message.EncryptionParams getEncryptionParams();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.Split> 
      getSplitList();
  /**
   * <code>repeated .Split split = 15;</code>
   */
  com.github.yeriomin.playstore.message.Split getSplit(int index);
  /**
   * <code>repeated .Split split = 15;</code>
   */
  int getSplitCount();
