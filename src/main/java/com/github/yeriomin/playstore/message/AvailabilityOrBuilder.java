...
public interface AvailabilityOrBuilder extends
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.Availability.PerDeviceAvailabilityRestriction> 
      getPerDeviceAvailabilityRestrictionList();
  /**
   * <code>repeated group PerDeviceAvailabilityRestriction = 9 { ... }</code>
   */
  com.github.yeriomin.playstore.message.Availability.PerDeviceAvailabilityRestriction getPerDeviceAvailabilityRestriction(int index);
  /**
   * <code>repeated group PerDeviceAvailabilityRestriction = 9 { ... }</code>
   */
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.Install> 
      getInstallList();
  /**
   * <code>repeated .Install install = 14;</code>
   */
  com.github.yeriomin.playstore.message.Install getInstall(int index);
  /**
   * <code>repeated .Install install = 14;</code>
   */
  int getInstallCount();
   ...
   * <code>optional .OwnershipInfo ownershipInfo = 17;</code>
   */
  com.github.yeriomin.playstore.message.OwnershipInfo getOwnershipInfo();
}
