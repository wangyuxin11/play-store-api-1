...
public  final class IpLayerNetworkBucket extends
  ...
  private com.google.protobuf.Internal.ProtobufList<com.github.yeriomin.playstore.message.StatCounters> statCounters_;
  /**
   * <code>repeated .StatCounters statCounters = 3;</code>
   */
  public java.util.List<com.github.yeriomin.playstore.message.StatCounters> getStatCountersList() {
    return statCounters_;
  }
  /**
   * <code>repeated .StatCounters statCounters = 3;</code>
   */
  public java.util.List<? extends com.github.yeriomin.playstore.message.StatCountersOrBuilder> 
   ...
   * <code>repeated .StatCounters statCounters = 3;</code>
   */
  public com.github.yeriomin.playstore.message.StatCounters getStatCounters(int index) {
    return statCounters_.get(index);
  }
  /**
   * <code>repeated .StatCounters statCounters = 3;</code>
   */
  public com.github.yeriomin.playstore.message.StatCountersOrBuilder getStatCountersOrBuilder(
      int index) {
    return statCounters_.get(index);
  }
  ...
  private void setStatCounters(
      int index, com.github.yeriomin.playstore.message.StatCounters value) {
    if (value == null) {
   ...
   */
  private void setStatCounters(
      int index, com.github.yeriomin.playstore.message.StatCounters.Builder builderForValue) {
    ensureStatCountersIsMutable();
   ...
   * <code>repeated .StatCounters statCounters = 3;</code>
   */
  private void addStatCounters(com.github.yeriomin.playstore.message.StatCounters value) {
    if (value == null) {
      throw new NullPointerException();
    }
    ensureStatCountersIsMutable();
   ...
   */
  private void addStatCounters(
      com.github.yeriomin.playstore.message.StatCounters.Builder builderForValue) {
    ensureStatCountersIsMutable();
  ...
  private void addAllStatCounters(
      java.lang.Iterable<? extends com.github.yeriomin.playstore.message.StatCounters> values) {
    ensureStatCountersIsMutable();
  ...
  public static com.github.yeriomin.playstore.message.IpLayerNetworkBucket parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.IpLayerNetworkBucket parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static com.github.yeriomin.playstore.message.IpLayerNetworkBucket parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.IpLayerNetworkBucket parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static com.github.yeriomin.playstore.message.IpLayerNetworkBucket parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.github.yeriomin.playstore.message.IpLayerNetworkBucket prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.github.yeriomin.playstore.message.IpLayerNetworkBucket, Builder> implements
      // @@protoc_insertion_point(builder_implements:IpLayerNetworkBucket)
      com.github.yeriomin.playstore.message.IpLayerNetworkBucketOrBuilder {
     ...
     * <code>repeated .StatCounters statCounters = 3;</code>
     */
    public Builder addStatCounters(com.github.yeriomin.playstore.message.StatCounters value) {
      copyOnWrite();
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.github.yeriomin.playstore.message.IpLayerNetworkBucket();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        com.github.yeriomin.playstore.message.IpLayerNetworkBucket other = (com.github.yeriomin.playstore.message.IpLayerNetworkBucket) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                ...
                statCounters_.add(
                    input.readMessage(com.github.yeriomin.playstore.message.StatCounters.parser(), extensionRegistry));
                break;
              }
              case 32: {
                bitField0_ |= 0x00000004;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.github.yeriomin.playstore.message.IpLayerNetworkBucket.class) {
            if (PARSER == null) {
  ...
  private static final com.github.yeriomin.playstore.message.IpLayerNetworkBucket DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new IpLayerNetworkBucket();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static com.github.yeriomin.playstore.message.IpLayerNetworkBucket getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
