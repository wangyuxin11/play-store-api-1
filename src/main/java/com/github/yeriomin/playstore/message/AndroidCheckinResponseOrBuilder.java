...
public interface AndroidCheckinResponseOrBuilder extends
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.AndroidIntentProto> 
      getIntentList();
  /**
   * <code>repeated .AndroidIntentProto intent = 2;</code>
   */
  com.github.yeriomin.playstore.message.AndroidIntentProto getIntent(int index);
  /**
   * <code>repeated .AndroidIntentProto intent = 2;</code>
   */
  int getIntentCount();
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.GservicesSetting> 
      getSettingList();
  /**
   * <code>repeated .GservicesSetting setting = 5;</code>
   */
  com.github.yeriomin.playstore.message.GservicesSetting getSetting(int index);
  /**
   * <code>repeated .GservicesSetting setting = 5;</code>
   */
  int getSettingCount();
