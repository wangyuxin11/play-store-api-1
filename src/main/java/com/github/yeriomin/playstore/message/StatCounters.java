...
public  final class StatCounters extends
  ...
  private com.github.yeriomin.playstore.message.CounterData counterData_;
  /**
   ...
   * <code>optional .CounterData counterData = 3;</code>
   */
  public com.github.yeriomin.playstore.message.CounterData getCounterData() {
    return counterData_ == null ? com.github.yeriomin.playstore.message.CounterData.getDefaultInstance() : counterData_;
  }
  /**
   * <code>optional .CounterData counterData = 3;</code>
   */
  private void setCounterData(com.github.yeriomin.playstore.message.CounterData value) {
    if (value == null) {
  ...
  private void setCounterData(
      com.github.yeriomin.playstore.message.CounterData.Builder builderForValue) {
   ...
   * <code>optional .CounterData counterData = 3;</code>
   */
  private void mergeCounterData(com.github.yeriomin.playstore.message.CounterData value) {
    if (counterData_ != null &&
        counterData_ != com.github.yeriomin.playstore.message.CounterData.getDefaultInstance()) {
      counterData_ =
        com.github.yeriomin.playstore.message.CounterData.newBuilder(counterData_).mergeFrom(value).buildPartial();
    } else {
      counterData_ = value;
    }
    bitField0_ |= 0x00000004;
  ...
  public static com.github.yeriomin.playstore.message.StatCounters parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.StatCounters parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static com.github.yeriomin.playstore.message.StatCounters parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.StatCounters parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static com.github.yeriomin.playstore.message.StatCounters parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.github.yeriomin.playstore.message.StatCounters prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.github.yeriomin.playstore.message.StatCounters, Builder> implements
      // @@protoc_insertion_point(builder_implements:StatCounters)
      com.github.yeriomin.playstore.message.StatCountersOrBuilder {
     ...
     * <code>optional .CounterData counterData = 3;</code>
     */
    public Builder setCounterData(com.github.yeriomin.playstore.message.CounterData value) {
      copyOnWrite();
     ...
     * <code>optional .CounterData counterData = 3;</code>
     */
    public Builder mergeCounterData(com.github.yeriomin.playstore.message.CounterData value) {
      copyOnWrite();
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.github.yeriomin.playstore.message.StatCounters();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        com.github.yeriomin.playstore.message.StatCounters other = (com.github.yeriomin.playstore.message.StatCounters) arg1;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                com.github.yeriomin.playstore.message.CounterData.Builder subBuilder = null;
                if (((bitField0_ & 0x00000004) == 0x00000004)) {
                  subBuilder = counterData_.toBuilder();
                }
                counterData_ = input.readMessage(com.github.yeriomin.playstore.message.CounterData.parser(), extensionRegistry);
                if (subBuilder != null) {
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.github.yeriomin.playstore.message.StatCounters.class) {
            if (PARSER == null) {
  ...
  private static final com.github.yeriomin.playstore.message.StatCounters DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new StatCounters();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static com.github.yeriomin.playstore.message.StatCounters getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
