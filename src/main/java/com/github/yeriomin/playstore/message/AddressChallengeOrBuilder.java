...
public interface AddressChallengeOrBuilder extends
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.FormCheckbox> 
      getCheckboxList();
  /**
   * <code>repeated .FormCheckbox checkbox = 5;</code>
   */
  com.github.yeriomin.playstore.message.FormCheckbox getCheckbox(int index);
  /**
   * <code>repeated .FormCheckbox checkbox = 5;</code>
   */
   ...
   * <code>optional .Address address = 6;</code>
   */
  com.github.yeriomin.playstore.message.Address getAddress();

  /**
   * <code>repeated .InputValidationError errorInputField = 7;</code>
   */
  java.util.List<com.github.yeriomin.playstore.message.InputValidationError> 
      getErrorInputFieldList();
  /**
   * <code>repeated .InputValidationError errorInputField = 7;</code>
   */
  com.github.yeriomin.playstore.message.InputValidationError getErrorInputField(int index);
  /**
   * <code>repeated .InputValidationError errorInputField = 7;</code>
   */
