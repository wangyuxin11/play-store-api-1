...
public interface AppDetailsOrBuilder extends
   ...
   */
  java.util.List<com.github.yeriomin.playstore.message.FileMetadata> 
      getFileList();
  /**
   * <code>repeated .FileMetadata file = 17;</code>
   */
  com.github.yeriomin.playstore.message.FileMetadata getFile(int index);
  /**
   * <code>repeated .FileMetadata file = 17;</code>
   */
  int getFileCount();
   ...
   * <code>optional .Dependencies dependencies = 34;</code>
   */
  com.github.yeriomin.playstore.message.Dependencies getDependencies();
   ...
   * <code>optional .TestingProgramInfo testingProgramInfo = 35;</code>
   */
  com.github.yeriomin.playstore.message.TestingProgramInfo getTestingProgramInfo();
   ...
   * <code>optional .EarlyAccessInfo earlyAccessInfo = 36;</code>
   */
  com.github.yeriomin.playstore.message.EarlyAccessInfo getEarlyAccessInfo();
