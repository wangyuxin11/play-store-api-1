...
public  final class GetReviewsResponse extends
  ...
  private com.google.protobuf.Internal.ProtobufList<com.github.yeriomin.playstore.message.Review> review_;
  /**
   * <code>repeated .Review review = 1;</code>
   */
  public java.util.List<com.github.yeriomin.playstore.message.Review> getReviewList() {
    return review_;
  }
  /**
   * <code>repeated .Review review = 1;</code>
   */
  public java.util.List<? extends com.github.yeriomin.playstore.message.ReviewOrBuilder> 
   ...
   * <code>repeated .Review review = 1;</code>
   */
  public com.github.yeriomin.playstore.message.Review getReview(int index) {
    return review_.get(index);
  }
  /**
   * <code>repeated .Review review = 1;</code>
   */
  public com.github.yeriomin.playstore.message.ReviewOrBuilder getReviewOrBuilder(
      int index) {
    return review_.get(index);
  }
  ...
  private void setReview(
      int index, com.github.yeriomin.playstore.message.Review value) {
    if (value == null) {
   ...
   */
  private void setReview(
      int index, com.github.yeriomin.playstore.message.Review.Builder builderForValue) {
    ensureReviewIsMutable();
   ...
   * <code>repeated .Review review = 1;</code>
   */
  private void addReview(com.github.yeriomin.playstore.message.Review value) {
    if (value == null) {
      throw new NullPointerException();
    }
    ensureReviewIsMutable();
  ...
  private void addAllReview(
      java.lang.Iterable<? extends com.github.yeriomin.playstore.message.Review> values) {
    ensureReviewIsMutable();
  ...
  public static com.github.yeriomin.playstore.message.GetReviewsResponse parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.GetReviewsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static com.github.yeriomin.playstore.message.GetReviewsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static com.github.yeriomin.playstore.message.GetReviewsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static com.github.yeriomin.playstore.message.GetReviewsResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.github.yeriomin.playstore.message.GetReviewsResponse prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.github.yeriomin.playstore.message.GetReviewsResponse, Builder> implements
      // @@protoc_insertion_point(builder_implements:GetReviewsResponse)
      com.github.yeriomin.playstore.message.GetReviewsResponseOrBuilder {
     ...
     * <code>repeated .Review review = 1;</code>
     */
    public Builder addReview(com.github.yeriomin.playstore.message.Review value) {
      copyOnWrite();
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.github.yeriomin.playstore.message.GetReviewsResponse();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        com.github.yeriomin.playstore.message.GetReviewsResponse other = (com.github.yeriomin.playstore.message.GetReviewsResponse) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                ...
                review_.add(
                    input.readMessage(com.github.yeriomin.playstore.message.Review.parser(), extensionRegistry));
                break;
              }
              case 16: {
                bitField0_ |= 0x00000001;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.github.yeriomin.playstore.message.GetReviewsResponse.class) {
            if (PARSER == null) {
  ...
  private static final com.github.yeriomin.playstore.message.GetReviewsResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetReviewsResponse();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static com.github.yeriomin.playstore.message.GetReviewsResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
